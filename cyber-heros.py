...
#coding=utf-8
#Mustafa-Kamagr
#Instagram:@mustafa.kamgar
#Telegram :t.me/Hacking_by_Mustafa
...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mMustafaKamgar█████████████████▒▒▒▒▒▒▒▒..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
os.system("clear")
os.system ('figlet -f small CLONE FB BY ifan |lolcat')

CorrectPasscode = "ifan"
...
while (loop == 'true'):
    ...
    if (passcode == CorrectPasscode):
            print """
            \033[1;92mWelcome CYBER-HEROS
               """
            loop = 'false'
    else:
            print "\033[1;91m☠️WRONG"
            os.system('xdg-open https://www.facebook.com/never.try.to.hack.00')
...
def Zeek():
    os.system('clear')
    os.system ('figlet -f small CLONE FB 8 COUNTRY By IFAN |lolcat')
...
def action():
    ...
    jalan ("\033[1;92mMustafa~Kamgar██████▒▒▒..99%Start Cracking...")
    ...
    p.map(main, id)
    print 50* '\033[1;91m-'
    print 'Mustafa~Kamagar Process Has Been Completed██████▒▒▒▒...100%'
